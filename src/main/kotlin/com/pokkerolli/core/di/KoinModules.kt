package com.pokkerolli.core.di

import androidx.room.Room
import androidx.room.migration.Migration
import androidx.sqlite.SQLiteConnection
import androidx.sqlite.driver.bundled.BundledSQLiteDriver
import com.pokkerolli.config.AppConfig
...
import com.pokkerolli.data.local.datastore.ActiveSessionPreferences
import com.pokkerolli.data.local.db.AppDatabase
import com.pokkerolli.data.datasource.ChatDataSourceImpl
import com.pokkerolli.data.remote.api.DeepSeekApi
import com.pokkerolli.data.remote.stream.SseStreamParser
import com.pokkerolli.domain.datasource.ChatDataSource
import com.pokkerolli.domain.repository.ChatRepository
import com.pokkerolli.domain.usecase.CreateCustomUserProfilePresetFromDraftUseCase
import com.pokkerolli.domain.usecase.CreateSessionBranchUseCase
import com.pokkerolli.domain.usecase.CreateSessionUseCase
import com.pokkerolli.domain.usecase.DeleteSessionUseCase
import com.pokkerolli.domain.usecase.GetActiveSessionUseCase
import com.pokkerolli.domain.usecase.ObserveMessagesUseCase
import com.pokkerolli.domain.usecase.ObserveSessionsUseCase
import com.pokkerolli.domain.usecase.ObserveUserProfilePresetsUseCase
import com.pokkerolli.domain.usecase.RunContextSummarizationIfNeededUseCase
import com.pokkerolli.domain.usecase.SendMessageUseCase
import com.pokkerolli.domain.usecase.SetActiveSessionUseCase
import com.pokkerolli.domain.usecase.SetSessionContextWindowModeUseCase
import com.pokkerolli.domain.usecase.SetSessionSystemPromptUseCase
import com.pokkerolli.domain.usecase.SetSessionUserProfileUseCase
import com.pokkerolli.domain.usecase.StreamUserProfileBuilderReplyUseCase
import com.pokkerolli.presentation.chat.ChatViewModel
